...
const INPUT_FILE = "./src/db/scripts/input/moderated_data.t.json";
const OUTPUT_DIR = `./src/db/scripts/out/${MARKING_GROUP}/moderated`;
...
async function main() {
  ...
  for (const entry of data) {
    ...
    const html = await render(ModeratedSummary(templateData));
...
function transformDataForTemplate(entry: StudentEntry): ModeratedSummaryProps {
  return {
